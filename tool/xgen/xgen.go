...
import (
	...
	"github.com/werunclub/rpcx/v4/tool/xgen/parser"
)
...
func generate(parsers []*parser.Parser) error {
	...
	fmt.Fprintln(w, `  "github.com/werunclub/rpcx/v4/server"`)
	fmt.Fprintln(w, `  "github.com/werunclub/rpcx/v4/serverplugin"`)
